...
$ui = @{
    ...
    Syntax = 'A*B, A.*B, A./B, A^2, ROWSUMS(A), COLMEANS(A), ROWMAXS(A), ' + (S '%E7%94%B2') + '*' + (S '%E4%B9%99') + ', ' + (S '%E8%BD%AC%E7%BD%AE') + '(A), RREF(A), NORM(A), I3, [A | B; B | A]'
...
function Show-HistoryWindow {
    if ($null -eq $script:historyForm -or $script:historyForm.IsDisposed) {
        $script:historyForm = New-Object System.Windows.Forms.Form
...
function Show-DataWindow {
    if ($null -eq $script:dataForm -or $script:dataForm.IsDisposed) {
        $script:dataForm = New-Object System.Windows.Forms.Form
        ...
        $script:dataForm.Controls.Add($topCard)
        ...
        $title.Size = New-Object System.Drawing.Size(240, 24)
        ...
        $script:dataFileLabel.Location = New-Object System.Drawing.Point(18, 40)
        $script:dataFileLabel.Size = New-Object System.Drawing.Size(760, 20)
        $topCard.Controls.Add($script:dataFileLabel)

        $script:dataStatusLabel = New-Object System.Windows.Forms.Label
        $script:dataStatusLabel.Text = $ui.DataStatusReady
        $script:dataStatusLabel.Location = New-Object System.Drawing.Point(18, 64)
        $script:dataStatusLabel.Size = New-Object System.Drawing.Size(760, 20)
        $topCard.Controls.Add($script:dataStatusLabel)

        $buttonFlow = New-Object System.Windows.Forms.FlowLayoutPanel
        $buttonFlow.Location = New-Object System.Drawing.Point(18, 94)
        $buttonFlow.Size = New-Object System.Drawing.Size(1170, 74)
        ...
        $topCard.Controls.Add($buttonFlow)
        ...
        $topCard.Add_Resize({
            $buttonFlow.Width = [Math]::Max(320, $topCard.ClientSize.Width - 36)
        })

        $script:dataGridHost = New-Object System.Windows.Forms.Panel
        $script:dataGridHost.Dock = 'Fill'
        $script:dataGridHost.Padding = New-Object System.Windows.Forms.Padding(12)
        $script:dataForm.Controls.Add($script:dataGridHost)
        ...
        $script:dataGridHost.Controls.Add($script:dataGridView)
...
$script:variableQuickPanel.Size = New-Object System.Drawing.Size(760, 44)
...
$script:updateAdaptiveLayout = {
    ...
    $operatorLabel.Top = 292
    $script:functionQuickPanel.Left = $exprLeft
    $script:functionQuickPanel.Top = 320
    $script:functionQuickPanel.Width = $contentWidth
    $script:functionQuickPanel.Height = [Math]::Max(70, $expressionCard.ClientSize.Height - 336)
